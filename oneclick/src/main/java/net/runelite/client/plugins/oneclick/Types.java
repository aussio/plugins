...
import net.runelite.client.plugins.oneclick.comparables.misc.Compost;
...
import net.runelite.client.plugins.oneclick.comparables.misc.Herbtar;
import net.runelite.client.plugins.oneclick.comparables.misc.Seeds;
import net.runelite.client.plugins.oneclick.comparables.misc.TroubleBrewing;
import net.runelite.client.plugins.oneclick.comparables.skilling.Birdhouses;
import net.runelite.client.plugins.oneclick.comparables.skilling.Bones;
import net.runelite.client.plugins.oneclick.comparables.skilling.DarkEssence;
import net.runelite.client.plugins.oneclick.comparables.skilling.Darts;
import net.runelite.client.plugins.oneclick.comparables.skilling.Firemaking;
import net.runelite.client.plugins.oneclick.comparables.skilling.Karambwans;
import net.runelite.client.plugins.oneclick.comparables.skilling.Runes;
import net.runelite.client.plugins.oneclick.comparables.skilling.Tiara;
